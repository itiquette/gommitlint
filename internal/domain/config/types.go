...
type BodyConfig struct {
	...
	MinLines         int  `json:"min_lines"          toml:"min_lines"          yaml:"min_lines"`
	AllowSignoffOnly bool `json:"allow_signoff_only" toml:"allow_signoff_only" yaml:"allow_signoff_only"`
	RequireSignoff   bool `json:"require_signoff"    toml:"require_signoff"    yaml:"require_signoff"`
}
...
type SigningConfig struct {
	RequireSignature    bool     `json:"require_signature"     toml:"require_signature"     yaml:"require_signature"`
	RequireVerification bool     `json:"require_verification"  toml:"require_verification"  yaml:"require_verification"`
	RequireMultiSignoff bool     `json:"require_multi_signoff" toml:"require_multi_signoff" yaml:"require_multi_signoff"`
