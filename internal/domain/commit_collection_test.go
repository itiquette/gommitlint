...
func TestCommitCollection_FirstLast(t *testing.T) {
	...
	require.Nil(t, emptyCollection.First(), "First() should return nil for empty collection")
	require.Nil(t, emptyCollection.Last(), "Last() should return nil for empty collection")
