...
func NewRepository(ctx context.Context, path string, logger ports.Logger) (Repository, error) {
	...
	if path == "" {
		...
		path, err = os.Getwd()
		if err != nil {
			return Repository{}, fmt.Errorf("failed to get current directory: %w", err)
		}
	}
	...
	if err != nil {
		return Repository{}, fmt.Errorf("failed to find git directory: %w", err)
	}
...
func (g Repository) GetCommit(ctx context.Context, hash string) (domain.CommitInfo, error) {
...
func (g Repository) GetCommits(ctx context.Context, count int) ([]domain.CommitInfo, error) {
...
func (g Repository) getCommitsFromHash(_ context.Context, hashOrRef string, count int) ([]domain.CommitInfo, error) {
...
func (g Repository) GetCommitRange(_ context.Context, fromHash, toHash string) ([]domain.CommitInfo, error) {
...
func (g Repository) CountCommitsSince(_ context.Context, reference string) (int, error) {
...
func (g Repository) GetRepositoryName(_ context.Context) string {
	return filepath.Base(g.path)
}

// IsValid checks if the repository is valid.
func (g Repository) IsValid(_ context.Context) (bool, error) {
...
func (g Repository) GetHeadCommits(ctx context.Context, count int) ([]domain.CommitInfo, error) {
...
func (g Repository) GetCurrentBranch(_ context.Context) (string, error) {
...
func (g Repository) GetCommitsAhead(ctx context.Context, ref string) (int, error) {
...
func findGitDir(_ context.Context, startPath string, logger ports.Logger) (string, error) {
