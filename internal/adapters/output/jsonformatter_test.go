...
func TestJSON_ValidReport(t *testing.T) {
	...
	require.InEpsilon(t, 1, jsonData["totalCommits"], 0.01)
	require.InEpsilon(t, 0, jsonData["passedCommits"], 0.01)
	...
	require.InEpsilon(t, 1, ruleSummary["TestRule"], 0.01)
	...
	require.InEpsilon(t, 1, commitData["errorCount"], 0.01)
...
func TestJSON_EmptyReport(t *testing.T) {
	...
	require.InEpsilon(t, 0, jsonData["totalCommits"], 0.01)
	require.InEpsilon(t, 0, jsonData["passedCommits"], 0.01)
}
