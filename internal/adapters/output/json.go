...
// It implements the Formatter interface.
...
func (JSONFormatter) Format(_ context.Context, results interface{}) string {
	...
	report := ValidationResultsOutput{
		...
		RuleSummary:   validationResults.GetFailedRules(),
...
// This pure function handles the transformation without modifying state.
func transformValidationErrors(validationErrors []domain.ValidationError) []ValidationErrorOutput {
