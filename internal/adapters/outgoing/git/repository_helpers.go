...
// func resolveRevision(_ context.Context, repo *git.Repository, revision string, logger outgoing.Logger) (plumbing.Hash, error) {
...
// func getCommitByHash(_ context.Context, repo *git.Repository, hash plumbing.Hash, logger outgoing.Logger) (*object.Commit, error) {
...
// func createCommitIterator(_ context.Context, repo *git.Repository, hash plumbing.Hash, logger outgoing.Logger) (object.CommitIter, error) {
...
// func getAncestors(ctx context.Context, repo *git.Repository, commit *object.Commit, logger outgoing.Logger) (map[plumbing.Hash]bool, error) {
...
// func getAncestorsWithAccumulator(_ context.Context, repo *git.Repository, commit *object.Commit, ancestors map[plumbing.Hash]bool, logger outgoing.Logger) (map[plumbing.Hash]bool, error) {
...
// func findMergeBase(ctx context.Context, repo *git.Repository, hash1, hash2 plumbing.Hash, logger outgoing.Logger) (plumbing.Hash, error) {
...
// func findCommonAncestor(_ context.Context, repo *git.Repository, startCommit *object.Commit, ancestorsMap map[plumbing.Hash]bool, logger outgoing.Logger) (plumbing.Hash, error) {
