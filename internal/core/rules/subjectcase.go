...
func (r SubjectCaseRule) Result(_ []appErrors.ValidationError) string {
	result := resultImpl(r)
...
func (r SubjectCaseRule) VerboseResult(_ []appErrors.ValidationError) string {
...
func (r SubjectCaseRule) Help(_ []appErrors.ValidationError) string {
	return helpImpl(r)
}
