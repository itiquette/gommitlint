...
var (
	_ domain.CommitRepository       = (*GitRepositoryAdapter)(nil)
	_ domain.RepositoryInfoProvider = (*GitRepositoryAdapter)(nil)
	_ domain.CommitAnalyzer         = (*GitRepositoryAdapter)(nil)
)
