...
* link:.gommitlint-full-example.yaml[Configuration Example] - Full configuration with all options
  ...
  gommitlint:
    message:
      subject:
        ...
        imperative: true         # Whether subjects should use imperative mood
        case: "sentence"         # Options: sentence, lower, upper, title
      ...
      body:
        ...
        allow_signoff_only: true # Whether body can only contain sign-off info
        require_sign_off: false  # Whether sign-off is required
